...
<html lang="en">
    ...
    <body>
        ...
        <main class="font-sans max-w-4xl mx-auto">
            ...
            <br>
            <img id="imagenPresentacion" class=" mx-auto border-black rounded-lg my-[10px]" src="https://preview.redd.it/old-league-of-legends-art-as-posters-v0-0iw2kxwp1fee1.jpg?width=1080&crop=smart&auto=webp&s=076db3427c43651c6367ebfee566cb1b734a4734" alt="imagen de lol" height="420" width="640">
            ...
            <!--es el lab6 el comparador de contraseñas-->
            <hr class="my-4">

            <section id="seccion-validador" class="font-sans max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-sm border border-gray-100">
                <h2 class="text-xl text-center text-[#703d56] font-bold mb-4">Validador de contraseña</h2>
                ...
                <div class="max-w-xs mx-auto space-y-4">
                    <div>
                        ...
                        <div class="w-full bg-gray-200 h-2 mt-2 rounded-full overflow-hidden">
                            <div id="fuerza-barra" class="h-full w-0 transition-all duration-300"></div>
                        </div>
